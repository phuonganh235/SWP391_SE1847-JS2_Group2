...
<html lang="zxx">
    ...
    <body>
        ...
        <div class="container success-container">
            ...
            <p>Cảm ơn bạn đã mua hàng. Đơn hàng của bạn sẽ được nhân viên xác nhận sớm nhất.</p>
            <p><strong>Một vài quy định mua hàng của shop</strong></p>
            <p>1. Chỉ được hủy đơn hàng khi thanh toán bằng COD và đơn hàng chưa được xác nhận !!</p>
            <p>Hãy có trách nhiệm với đơn hàng của mình nhé </p>
