                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="addShipperForm" action="manageAccountAdmin?service=insertShipper" method="post">
                                            ...
                                            <div class="mb-3">
                                                <label for="dateOfbirth" for="birth" class="form-label">Sinh nhật</label>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="formShipperUpdate" action="manageAccountAdmin?service=eiditShipper" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" id="dateOfBirthUpdate" name="birth" value="${not empty param.birth ? param.birth : dataShipper.dateofbirth}" required>
