...
<html lang="en">
    ...
    <body>
                ...
                <div class="container-fluid pt-4 px-4">
                    ...
                    <div class="bg-light text-center rounded p-4">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0 " id="consultationTable">
                                <thead>
                                    <tr class="text-dark">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${requestScope.listAll1}" var="consultaion">
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <c:if test="${consultaion.status == 1}">
                                                    chờ xử lý
                                                </c:if>
                                            </td>
        ...
        <script>
            function confirmConsultaion(consultationId, customerName) {
                if (confirm("bạn đã gọi điện cho khác hàng " + customerName + "?")) {
