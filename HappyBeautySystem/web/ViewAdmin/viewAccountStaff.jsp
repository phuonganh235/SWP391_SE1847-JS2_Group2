...
<html lang="en">
    ...
    <body>
            ...
            <div class="content">
                ...
                <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                    ...
                    <form class="d-none d-md-flex ms-4" action="manageAccountAdmin?service=search" method="post">
                        ...
                        <input class="form-control border-0" type="search" placeholder="Search by name" name="search">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <h6 class="mb-4"><a href="manageAccountAdmin?service=ActionCreate" >Create Account staff</a></h6>
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <c:forEach items="${requestScope.dataStaff}" var="s" >
                                            <tbody>
                                                <tr>
        ...
        <script>function doDeleteStaff(staffId) {
