                ...
                <div id="editProductModal">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <c:set value="${requestScope.StaffData}" var="staff"/>
                            <form action="manageAccountAdmin?service=edit" method="post">
                                <div class="modal-header">						
                                    <h4 class="modal-title">edit account staff</h4>
                                </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="namestaf" name="name" value="${staff.name}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="password" name="password" value="${staff.password}" required>
                                    </div>
