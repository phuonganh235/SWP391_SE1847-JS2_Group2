...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            #consultationTable3 th,
            #consultationTable3 td {
                padding: 0.75rem;
                vertical-align: top;
                border-top: 1px solid #dee2e6;
            }
            #consultationTable3 thead th {
                vertical-align: bottom;
                border-bottom: 2px solid #dee2e6;
                background-color: #f8f9fa;
            }
            #consultationTable3 tbody tr:nth-of-type(odd) {
                background-color: rgba(0, 0, 0, 0.05);
            }
            #consultationTable3 tbody tr:hover {
    ...
    <body>
                ...
                <div class="container-fluid pt-4 px-4">
                    ...
                    <div class="bg-light text-center rounded p-4">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0 " id="consultationTable3">
                                <thead>
                                    <tr class="text-dark">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${requestScope.listAll3}" var="consultaion">
        ...
        <script>
                                                    $(document).ready(function () {
                                                        var table = $('#consultationTable3').DataTable({
                                                            "pageLength": 5,
