<%-- 
    Document   : index-2
    Created on : Jun 18, 2024, 7:45:16 AM
    Author     : admin
--%>
...
<body>
	...
	<header class="header-top bg-dark justify-content-between navigation-dark">
		<nav class="navbar navbar-expand-lg navigation ">
			<div class="container">
				<a class="navbar-brand d-lg-none" href="index-2.html"><img src="images/logo-w.png" alt="" class="img-fluid"></a>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-6 text-center">
					<a class="navbar-brand d-none d-lg-block" href="index-3.html"><img src="images/logo.png" alt=""
							class="img-fluid"></a>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
					<article class="post-grid mb-5">
						...
						<div class="post-content mt-4">
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio iusto debitis repellat ab nostrum
								veritatis sequi harum delectus, explicabo suscipit incidunt, sunt veniam animi inventore. Sint fuga,
								laborum numquam eius!</p>
					...
					<div class="row">
						<div class="col-lg-6">
							<article class="post-grid mb-5">
								...
								<div class="post-content mt-4">
									<p>Quisque hendrerit lobortis faucibus. Fusce quis dignissim nunc, eget scelerisque lectus. Nunc id
										eros vel ante consequat laoreet non et mauris.</p>
								</div>
							</article>
						</div>
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<article class="post-grid mb-5">
								...
								<span class="font-sm text-color letter-spacing text-uppercase post-meta font-extra">lifestyle</span>
								<h3 class="post-title mb-1 mt-2"><a href="blog-single.html">8 Powerful Ways to Add Vibrant Colour to
										Your Life</a></h3>
