<%-- 
    ...
    Created on : Jun 18, 2024, 7:46:20 AM
    Author     : admin
--%>
                            ...
                            <article class="post">
                                ...
                                <div class="post-img mb-4">
                                    <div class="post_gallery owl-carousel owl-theme">
                                        <div class="item">
                                            <a href="#"><img class="img-fluid" src="images/fashion/img-1.jpg"
                                                    alt="" /></a>
                                        </div>
                                        <div class="item">
                                            <a href="#"><img class="img-fluid" src="images/fashion/img-2.jpg"
                                                    alt="" /></a>
                                        </div>
                                        <div class="item">
                                            <a href="#"><img class="img-fluid" src="images/fashion/img-3.jpg"
                                                    alt="" /></a>
                                        </div>
                                    </div>
                                </div>
