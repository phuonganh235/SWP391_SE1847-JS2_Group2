<%-- 
    Document   : index-6
    Created on : Jun 18, 2024, 7:45:52 AM
    Author     : admin
--%>
...
<body>
					...
					<ul id="menu" class="menu navbar-nav mx-auto">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="index.html">Home Grid</a>
								<a class="dropdown-item" href="index-4.html">Home Masonary</a>
								<a class="dropdown-item" href="index-2.html">Home List</a>
								<a class="dropdown-item" href="index-3.html">Home Big Post</a>
								<a class="dropdown-item" href="index-5.html">Home Handy</a>
								<a class="dropdown-item" href="index-6.html">Home Spilt</a>
							</div>
						</li>
						<li class="nav-item dropdown">
							...
							<ul class="list-unstyled ">
								...
								<li class="nav-item dropdown">
									<a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-toggle="dropdown"
										aria-haspopup="true" aria-expanded="false">Blog Posts +</a>
								...
								<li class="nav-item dropdown">
									<a class="nav-link dropdown-toggle" href="#" id="dropdown03" data-toggle="dropdown"
										aria-haspopup="true" aria-expanded="false">Posts Format +</a>
								...
								<li class="nav-item">
									<a class="nav-link" href="fashion.html">Category</a>
								</li>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<article class="post-grid mb-5">
						...
						<div class="post-content-grid">
							...
							<span class="cat-name text-color font-sm font-extra text-uppercase letter-spacing">Lifestyle</span>
							<h3 class="post-title mt-1"><a href="blog-single.html">The best to-do list to boost your productivity</a>
							</h3>
							<p>Lorem ipsum dolor sitamet consectetu ocilng elit. Donec eros aseb dui, suscipit ex uti commodo dignis
								justo acas turpis egestas. Nullam et cursus</p>
						</div>
	...
	<div class="footer-home bg-grey py-4">
		<div class="row">
			<div class="col-lg-6 text-center text-lg-left">
				© 2019 copyright Themes Themefisher Distribution <a href="https://themewagon.com">ThemeWagon.</a>
			</div>
			<div class="col-lg-6">
