...
//          Phân trang
            ...
            // Số trang cần cho mỗi trang có 9 mục sp
            ...
            int start, end;
            start = (page - 1) * numperpage;// Chỉ số của sp đầu tiên trên trang 
            end = Math.min(page * numperpage, size);// end k quá số sp
...
//          request.setAttribute("CategoryData", category);
            request.setAttribute("ProductData", productByPage);
            request.getRequestDispatcher("/ViewUser/shop.jsp").forward(request, response);
        }
    }
